...
function addGamesToPage(games) {
    ...
    for (let i=0; i<games.length; i++) {
        ...
        <p>${game.name}</p> 
        <p>${game.pledged} pledged out of ${game.goal}</p>
        `
...
const descriptionString = `A total amount of ${totalRaised} has been raised for ${totalGames} ${totalGames == 1 ? "game" : "games"}. Currently, ${totalUnfunded} ${totalUnfunded == 1 ? "game" : "games"} ${totalUnfunded == 1 ? "remains" : "remain"} unfunded. We need your help to fund these amazing games!`;
